...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-gray-300 text-base-content rounded">
            <div className='flex'>
            <Link to='/'><FaModx className='text-xl lg:text-4xl text-orange-600 font-bold'></FaModx></Link>
            <h1 className='text-xl lg:text-4xl text-orange-600 font-bold'><Link to='/'>Micro Tech</Link></h1>
            </div>
  ...
  <div>
    <p>Copyright © 2022 - All right reserved.Souvik Halder </p>
  </div>
</footer>
    );
};
