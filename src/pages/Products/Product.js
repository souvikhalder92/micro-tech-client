...
<div className="hero w-11/12 mx-auto bg-base-200">
  <div className="hero-content flex-col flex-col">
    ...
    <div className='py-5'>
      ...
      <p className="lg:py-6"><span className='font-bold'>Model:</span> {name}</p>
     
      <p className="lg:py-6"><span className='font-bold'>Key features:</span> {description}</p>
      ...
      <button className="btn btn-primary mx-48 mt-5 lg:px-8">Add To Cart</button>
    </div>
  </div>
</div>
    );
